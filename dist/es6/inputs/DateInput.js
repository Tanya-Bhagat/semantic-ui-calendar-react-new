        ...
        */
        _this.onInputValueChange = function (e, _a) {
            ...
            if (parsedValue.isValid()) {
                ...
                if (isString(_this.props.initialDate)) {
                    var parsedInitialDate = moment(_this.props.initialDate, _this.props.dateFormat);
                ...
                else if (moment.isMoment(_this.props.initialDate) && _this.props.initialDate.isValid()) {
                    year = _this.props.initialDate.year();
                    month = _this.props.initialDate.month();
                    date = _this.props.initialDate.date();
                }
                else if (moment.isDate(_this.props.initialDate)) {
